...
public class MemberController extends HttpServlet {
        ...
        /** 登入事件 */
	        ...
	        /** 透過MemberHelper物件的checkDuplicate()檢查該會員電子郵件信箱是否存在 */
	        	...
	        	if(mh.checkPassword(m)) {
		            ...
		            /** 從MemberHelper實現的JSON物件中撈出id及status */
		            resp.put("response", query.get("id"));
		            resp.put("member_status", query.get("status"));
    ...
    public void doDelete(HttpServletRequest request, HttpServletResponse response)
        ...
        String email = mh.getEmailByID(id);
        
        /** 透過MemberHelper物件的deleteByID()方法至資料庫刪除該名會員，回傳之資料為JSONObject物件 */
        JSONObject query = mh.deleteByID(email);
    ...
    public void doPut(HttpServletRequest request, HttpServletResponse response)
        ...
        if(action.equals("editdata")) {
	        ...
	        JSONObject query1 = mh.getEmail(id);
	        ...
	        JSONObject query = mh.getEmail(id);
